...
<html>
	...
	<body>
        ...
        <%-- 
            ...
            * include하는 JSP 마다 각각의 Java 파일과 클s래스들이 생성됨.
         --%>
        
		<h1>JSP Action Tag</h1>
        <%-- 
          JSP 액션 태그: 스크립트릿에서 사용되는 자바 코드들을 HTML 또는 XML 등에서 사용되는
          태그로 대체하기 위해서 정의된 태그
        ...
        <jsp:setProperty property="name" value="졸리다" name="c2"/>
        <p>
            c2.name: <jsp:getProperty property="name" name="c2"/>
        </p>
        ...
        <jsp:useBean id="c4" class="com.itwill.jsp1.model.Contact">
            ...
            <jsp:setProperty name="c4" property="phone" value="010-1234-4568"/>
            <jsp:setProperty name="c4" property="email" value="itwill.com"/>
        </jsp:useBean>
        <p>
